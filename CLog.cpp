...
void CLog::Put(bool v) noexcept                 { Tail(std::sprintf(Tail(), "%d", (v)? 1:0)); }
void CLog::Put(i8 v) noexcept                   { Tail(std::sprintf(Tail(), "%hhd", v)); }
void CLog::Put(i16 v) noexcept                  { Tail(std::sprintf(Tail(), "%hd", v)); }
void CLog::Put(i32 v) noexcept                  { Tail(std::sprintf(Tail(), "%ld", v)); }
...
void CLog::Put(u32 v) noexcept                  { Tail(std::sprintf(Tail(), "%lu", v)); }
